...
into the relevant Side Panel / Data Fields / Quick Entry layouts. Idempotent: a
field already present anywhere in the layout (or absent from the doctype) is left
untouched.
"""
...
TARGET_LAYOUTS = [
	...
	# Quick Entry = the create-modal layout; enrichment fields must be visible there.
