...
permission_query_conditions = {
	...
	"CRM Registry Enrichment Run": "crm.registry_enrichment.permissions.get_permission_query_conditions",
}
...
has_permission = {
	...
	"CRM Registry Enrichment Run": "crm.registry_enrichment.permissions.has_permission",
}
