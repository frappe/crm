...
> Full reference: see [custom-scripting.md](../docs/custom-scripting.md) for all supported properties, override priority, child table dot notation, per-row overrides, and section/tab overrides.
