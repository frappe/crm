...
class TwilioSettings(Document):
    friendly_resource_name = (
        "Next CRM"  # System creates TwiML app & API keys with this name.
    )
    ...
    def set_application_credentials(self, twilio):
        ...
        frappe.db.set_value(
            "Twilio Settings", "Twilio Settings", "twiml_sid", self.twiml_sid
        )
    ...
    def get_twilio_voice_url(self):
        url_path = "/api/method/next_crm.integrations.twilio.api.voice"
