...
frappe.ui.form.on("CRM Form Script", {
  refresh(frm) {
    ...
    if (frm.doc.is_standard && !frappe.boot.developer_mode) {
      frm.disable_form();
      frappe.show_alert(__("Standard Form Scripts can not be modified, duplicate the Form Script instead."));
    }
  ...
  add_enable_button(frm) {
    frm.add_custom_button(frm.doc.enabled ? __("Disable") : __("Enable"), () => {
