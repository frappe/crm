...
// Inline Lucide path content (matches the codebase's existing inline-SVG pattern).
const ICONS = {
...
const path = computed(() => ICONS[props.name] || ICONS['file-text'])
</script>
