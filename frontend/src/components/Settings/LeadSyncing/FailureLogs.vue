<template>
  <div v-if="selectedLog">
    <div class="flex justify-between items-center">
      ...
      <Button
        v-if="logDoc?.document?.retrySync && selectedLog.type != 'Synced'"
        :loading="logDoc?.document?.retrySync.loading"
  ...
  <ListView
    ...
    class="h-full"
    :columns="columns"
    :rows="failedLeadSyncLogList?.data"
    :options="{
      selectable: false,
      showTooltip: true,
      resizeColumn: false,
