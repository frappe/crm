<template>
  ...
  >
    ...
    <ListRows :rows="rows" v-slot="{ idx, column, item, row }">
      ...
      <ListRowItem v-else :item="item">
        <template #prefix>
          <div v-if="column.key === 'prospect_owner'">
            <Avatar
              v-if="item.full_name"
  ...
  />
  <ListBulkActions ref="listBulkActionsRef" v-model="list" doctype="Prospect" />
</template>
