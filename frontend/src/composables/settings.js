...
export const freepbxEnabled = ref(false)
...
createResource({
  ...
  onSuccess: (data) => {
    ...
    freepbxEnabled.value = Boolean(data.freepbx_enabled)
    defaultCallingMedium.value = data.default_calling_medium
    callEnabled.value = twilioEnabled.value || exotelEnabled.value || freepbxEnabled.value
  },
})
